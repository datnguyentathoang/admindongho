...
<!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <!-- end page title -->
                <?php
                                                include("./lib/tablenguoidung.php");
                                                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["them_nguoidung"])) {
                                                    add_nguoidung();}
                                                ?>
                    ...
                    <div class="col-lg-12" bis_skin_checked="1">
                        <div class="card" bis_skin_checked="1">
                            <div class="card-body" bis_skin_checked="1">
                                ...
                                <p class="card-title-desc">Vui lòng nhập đầy đủ thông tin</p>
                                <form action="" method="POST" type="submit">
								<!--Bắt đầu 1 dòng mới với 4 cột-->
                                    <div class="row" bis_skin_checked="1">
										<!--Khai báo cột 1-->
										...
										<div class="col-lg-2" bis_skin_checked="1">
                                            <div class="mb-3" bis_skin_checked="1">
                                                <div class="input-group" bis_skin_checked="1">
                                                    <input type="text" class="form-control" name="hovaten" placeholder="Họ tên">
                                                </div>
                                                <!-- input-group -->
                                            </div>
										</div>
                                        ...
                                        <div class="col-lg-2" bis_skin_checked="1">
                                            <div class="mb-3" bis_skin_checked="1">
                                            <button type="submit" name="them_nguoidung" class="btn btn-success">Thêm người đùng</button>
                                            </div>
									</div>
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Danh sách các bạn sinh viên đăng ký mượn sách</h4>
